...
typedef struct _MemoryBarrierResource {
  ...
  _MemoryBarrierResource(vk::AccessFlagBits src, vk::AccessFlagBits dst)
      : m_src(src), m_dst(dst) {}
...
typedef struct _BufferBarrierResource : public MemoryBarrierResource {
  ...
  _BufferBarrierResource(vk::AccessFlagBits src, vk::AccessFlagBits dst,
                         vk::Buffer& buffer,
                         vk::DescriptorBufferInfo descBufferInfo)
      : MemoryBarrierResource(src, dst),
        m_buffer(buffer),
        m_descBufferInfo(descBufferInfo) {}
...
typedef struct _ImageBarrierResource : public MemoryBarrierResource {
  ...
  _ImageBarrierResource(vk::AccessFlagBits src, vk::AccessFlagBits dst,
                        vk::Image& image,
